...
public interface UserAdminService {
    ...
    ResGetUserByIdDtoV1 getUserById(UUID id, UserRole loginUserRole);

    //[MASTER] 전체 사용자 목록 조회 (본인 제외 페이징)
    Page<ResGetUserByIdDtoV1> findAllUsers(Pageable validatedPageable, UUID myId, UserRole loginUserRole);
}
